      ...
      <div class="crud-card">
        ...
        <div class="crud-hero">
          ...
          <div class="crud-tabs" id="tabs">
            ...
            <a class="tab" data-tab="calificaciones" href="javascript:void(0)">Comparación de calificaciones</a>
          </div>
        </div>
          ...
          <section id="tab-total">
            ...
            <div class="actions" style="justify-content:flex-end;margin-top:14px">
              <form id="excelFormTotal" method="POST" action="{{ route('reportes.reprobados.exportar') }}">
                ...
                <button type="submit" class="btn btn-primary">Descargar Excel (Reprobados por módulo)</button>
              </form>
            </div>
          </section>

          {{-- TAB 2: Comparación de calificaciones --}}
          <section id="tab-calificaciones" style="display:none;">
            ...
            <div class="actions" style="justify-content:flex-end;margin-top:14px">
              <form id="excelFormCalificaciones" method="POST" action="{{ route('reportes.reprobados.exportar') }}">
                @csrf
                <input type="hidden" name="id_diplomado" id="diplomado_excel_calificaciones">
                <input type="hidden" name="tipo" value="calificaciones">
                <button type="submit" class="btn btn-primary">Descargar Excel (Comparación)</button>
              </form>
            </div>
          </section>
        </div>
