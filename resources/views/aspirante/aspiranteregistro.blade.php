  ...
  <div class="right">
    <div class="card">
      ...
      <form class="form" method="POST" action="{{ route('aspirante.register') }}">
        ...
        <input class="input" name="nombre" value="{{ old('nombre') }}" placeholder="Nombre(s)">
        <label class="label">Apellido paterno</label>
        <input class="input" name="apellidoP" value="{{ old('apellidoP') }}" placeholder="Apellido paterno">
        <label class="label">Apellido materno</label>
        <input class="input" name="apellidoM" value="{{ old('apellidoM') }}" placeholder="Apellido materno">
        <label class="label">Fecha de nacimiento</label>
        <input class="input" name="fecha_nac" type="date" value="{{ old('fecha_nac') }}">
        ...
        <input class="input" name="telefono" value="{{ old('telefono') }}" placeholder="Teléfono">
        <label class="label">Correo electrónico</label>
        <input class="input" name="correo" type="email" value="{{ old('correo') }}" placeholder="Correo electrónico">
